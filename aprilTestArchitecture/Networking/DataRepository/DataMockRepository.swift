...
class DataMockRepository: DataRepository {
    ...
    func getData(_ request: DataRequest) -> MutableObservable<Output> {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) { [weak self] in
            ...
            for index in 0...request.numberOfItems-1 {
                let newItem = DataResponse(id: "11111", name: "Test Name Mock \(index)", someValue: Int.random(in: 0...100))
